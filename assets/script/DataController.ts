...
export namespace Data {
    ...
    export class FishInfo {
        public static fish = [
            ...
            {id:8,name:'fish8',hp:1000,minSpeed:5,maxSpeed:10,multiple:1500,delay:644/2,weight:5},
            {id:9,name:'fish9',hp:1500,minSpeed:1,maxSpeed:3,multiple:2000,delay:950/2,weight:1},
            {id:10,name:'fish10',hp:80,minSpeed:15,maxSpeed:20,multiple:90,delay:50/2,weight:80},
            {id:11,name:'fish11',hp:100,minSpeed:3,maxSpeed:8,multiple:110,delay:204/2,weight:85},
            {id:12,name:'fish12',hp:70,minSpeed:8,maxSpeed:12,multiple:80,delay:246/2,weight:88},
            {id:13,name:'fish13',hp:150,minSpeed:9,maxSpeed:13,multiple:100,delay:138/2,weight:90},
            {id:14,name:'fish14',hp:500,minSpeed:5,maxSpeed:10,multiple:1000,delay:276/2,weight:30}
        ]
    }
